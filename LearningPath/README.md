...
Sections are the current ordered course units, not calendar weeks. Topics are separate semantic concept documents and are not numbered or owned by a particular section. A section may focus on one complex Topic or combine several smaller Topics, and the same Topic may support more than one section. Topic boundaries are chosen by conceptual coherence rather than by trying to make Topic count match section count. The recommended concept sequence is maintained in [Topics/README.md](../Topics/README.md).
...
All graded programming work lives under [Programming Assignments](../ProgrammingAssignments/).
